...
<%-- 
    ...
    Created on : 20-may-2012, 17:38:06
    Author     : user
--%>
      ...
      <img src="image/img.jpg">
        ...
        <div id="main"> 
          ...
          <div class="grid box-1" id="informativo">
            ...
            <p class="h5">&nbsp;</p>
            <p>Los datos y fotos proporcionados a la empresa serán guardados bajo la más estricta confidencialidad, no pudiendo ser divulgados a terceros, sólo serán usados por la empresa para fines comerciales y publicitarios, previa coordinación entre ambas partes.</p>
            <p>&nbsp;</p>
            <p>Att. El Administrador.</p>
          </div> 
