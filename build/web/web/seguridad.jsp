<%-- 
    Document   : seguridad
    Created on : 20-may-2012, 17:40:20
    Author     : user
--%>
...
<div id="header" class="HeaderWidth2">
  <div id="head">
   ...
   <img id="largeImg" src="image/Mallas%20de%20seguridad/Untitled-3.jpg" width="384" height="397">
                ...
                <div class="grid box-3"> 
                	<p class="h5">¿Que es una malla de seguridad?</p> 
                    <p class="parrafo14 txtJustify"> 
                    	La solucion que buscabas para tu hogar. Adios a tus temores que tu hijo pueda caer por la ventana, la escalera o el balcon.<br />
<br />
La malla de seguridad es una malla, generalmente hecha de nylon, que se usa para cubrir ventanas, balcones, escaleras, terrazas, ductos, etc., en general, cualquier abertura donde quepa un niño o mascota; reduciendo el riesgo de accidentes en el hogar producto de caídas de una altura considerable.<br />
<br />
No es una solución de seguridad contra robos. NO REEMPLAZA LA SUPERVISIÓN DEL CUIDADO DE SU NIÑO DE UN ADULTO RESPONSABLE.<br />
<br />
También contamos con otros productos de seguridad como rejas para las escaleras, protectores de bordes, etc.
                    </p> 
                    <form action="#" method="post" class="form_s_y_c">
                      <p> 
                    	<input type="text" class="InputW clear-input required" name="nom_y_ape" value="Nombres y Apellidos" alt="Nombres y Apellidos"> 
                    </p> 
                    <p> 
                    	<input type="text" class="InputW clear-input" name="telefono" value="Teléfono" alt="Teléfono"> 
                    </p> 
                    <p> 
                    	<input type="text" class="InputW clear-input required" name="correo" value="Correo Electrónico" alt="Correo Electrónico"> 
                    </p> 
                    <p> 
                    	<textarea class="InputW required" name="mensaje">Mensaje</textarea> 
                    </p>

                    <p class="padRight"> 
                    	<label class="lblsubmit"><button type="submit" class="submit">¡Recibe 10% dscto!</button></label>                
                    </p> 
                    </form> 
                </div> 
