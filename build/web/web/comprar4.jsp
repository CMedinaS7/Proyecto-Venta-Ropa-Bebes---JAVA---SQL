...
<%
	    ...
	    String Cliente = (String) sesion.getAttribute("Cliente");
            int codigo_venta = (int) (Math.random()*25+1);
			...
			for (DetalleVenta d : lista) {
                            ...
                            monto=monto + (Integer.parseInt(String.valueOf(d.getProducto().getPrecio())) * Integer.parseInt(String.valueOf(d.getCantidad())));
               }}
%>
        ...
        <div id="main"> 
            ...
            <div class="grid box-1"> 
            	...
            	<div class="box-2 span-10 lineaReg"> 
                    ...
                    <div class="last-child act"> 
                    	<span class="puntoAct">•</span><br> 
                        Confirmación
                    </div>               	
                </div> 
            	
<div id="imprimir" class="grid box-9"> 
                	<p class="h6">Datos de Cliente
                	</p>
                	<p class="parrafo17"> 
               			<label class="lblTit">Cliente</label> 
                    	<%=Usuario%>
                       <br>
          ...
          <p class="parrafo17"> 
               			<label class="lblTit">E-mail</label> 
                    	<%=Email%>
</p>
            <p class="parrafo17"> 
          ...
          <p class="h6">Datos de Facturación
               	  </p>
          <p class="parrafo17"> 
		    <label class="lblTit">Codigo de Factura</label> 
                    	V000 <%=codigo_venta%>
          </p>
          <p class="parrafo17"> 
		    <label class="lblTit">Monto Total</label> 
                    	S/. <%=monto%>
          </p>
          <div class="lineSeparator span-16"></div> 
                    <p class="h6">Datos de Pago
                	</p><p class="parrafo17"> 
           			  <label class="lblTit">Tipo de Pago</label> 
                    	Pago 
                    Presencial</p> 
                       <div class="lineSeparator span-16"></div> 
                    <p class="h6">Productos de la Compra
                	</p>   
                                      <%   
                    if(lista!=null){
			...
			for (DetalleVenta d : lista) {
				%>
                      ...
                      <p class="parrafo17"> 
           			  <label class="lblTit">Descripcion:</label> 
                    	<%=d.getProducto().getDescripcion()%></p>
                        <p class="parrafo17"> 
           			  <label class="lblTit">Precio:</label> 
                    	S/. <%=d.getProducto().getPrecio()%></p>      
                   ...
                   %> 
                    ...
                    <div> 
<label class="lblsubmit"><button type="button" class="submit" onClick="location.href='../moduloVenta?accion=RegistrarVenta&sb=<%=monto%>&cliente=<%=Cliente%>'">Continuar</button> <button type="button" class="submit" onClick="javascript:imprSelec('imprimir')">Imprimir</button>
                      </label>
                         </div>
                         <div>
