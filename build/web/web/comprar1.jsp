        ...
        <div id="main"> 
            ...
            <div class="grid box-1"> 
            	...
            	<div class="box-2 span-10 lineaReg"> 
                	<div> 
                    	<span class="puntoAct">&bull;</span><br> 
                        Registro
                    </div> 
                    <div class="act"> 
                    	<span class="punto">&bull;</span><br> 
                        Detalles
                    </div> 
                    <div> 
                    	<span class="punto">&bull;</span><br> 
                ...
                <div class="grid box-2 span-1"> 
                	<p class="parrafo18"><b>Usuario</b></p> 
                    <form method="post" action="../validarCliente" class="eCommerceProcess" 
                    id="eCommerceProcess">

                	<p>
                    	<label class="lbl" for="email">Correo Eléctronico</label>
                        <input type="text" class="InputW required email" name="email" id="email">
                    </p>

                    <p>
                    	<label class="lbl" for="clave">Contraseña</label>
                        <input type="password" class="InputW required" name="clave" id="clave">
                     
						<input type="hidden" value="si" name="compra" id="compra">                                                         
                    </p>  
             
                    <p>
                  <div class="clear"></div>
                  <label class="lblsubmit" style="margin-top:-13px">
                ...
                <div class="grid box-2"> 
                	<p class="parrafo18">Paso 1: Comprar Producto(s)</p> 
                    <p class="parrafo20"> 
                    	En este paso debe brindar sus datos personales, los cuales brindo al registrarse en este sitio web. Si aun no esta registrado puede hacerlo desde el boton superior &quot;REGISTRARSE&quot;.
                    </p> 
