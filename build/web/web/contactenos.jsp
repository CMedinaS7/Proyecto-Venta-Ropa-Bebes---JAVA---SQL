<%-- 
    ...
    Created on : 20-may-2012, 17:31:17
    Author     : user
--%>
...
<!--            <div class="imagen"> -->
            <div class="imagen"   style="height:auto"> 
        ...
        <div id="main"> 
            ...
            <div class="grid box-1"> 
            	...
            	<div class="grid box-2 span-1"> 
                	<form id="contact" method="post" action="" class="padBottom">
                	  <p> 
                          <input type="text" class="InputW required clear-input" 
                            value="Nombre" alt="Nombre" name="nombre"> 
                        </p> 
                        <p> 
                            <input type="text" class="InputW required clear-input" 
                            value="Correo electronico" alt="Correo electronico" name="correo"> 
                        </p> 
                        <p> 
                            <input type="text" class="InputW required clear-input" 
                            value="Telefono" alt="Telefono" name="telefono"> 
                        </p> 
                         <p> 
                            <select class="styled selectW" name="asunto"> 
                        ...
                        <p> 
                        	<textarea class="InputW" name="mensaje">Mensaje</textarea> 
                        </p> 
                        <p> 
                        	<label class="lblsubmit"><button type="submit" class="submit">Enviar</button></label>                                                  
                        </p> 
                ...
                <div class="grid box-3"> 
                	<p class="parrafo2"><strong>Av. España Nº 2350 - Boulevard  - 
                  Tel. 044-207654</strong></p>
               	  <p class="parrafo2"><strong>CC. Mall Aventura Plaza – LC -1181  - 
                	  Tel. 044-608235 <br>
               	    CC. Real Plaza – LC – 107 .:. -              Tel. 044-282259 </strong></p> 
                    <p class="parrafo2">&nbsp;</p>
                    <p class="parrafo2"> 
                    	<b>Correo El&eacute;ctronico:</b> contacto@babymodas.com
                  </p> 
                    <p class="parrafo2"> 
                    	<b>P&aacute;gina web:</b> http://www.baby-modas-prueba.com
                    </p> 
                    <p class="parrafo2"> 
                    	<center><iframe width="330" height="370" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com.pe/?ie=UTF8&amp;ll=-8.102526,-79.043176&amp;spn=0.014849,0.022724&amp;t=m&amp;z=16&amp;output=embed"></iframe></center> 
                    </p> 
                </div> 
