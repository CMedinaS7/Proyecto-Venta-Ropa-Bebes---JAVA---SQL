...
<%
            ...
            String nombres="",apellidos="",dni="",direccion="",telefono="",email="",cargo="",activo="0";
  ...
  <div class=grid_6>
    <div class=block-border>
      <div class=block-header>
        <h1>Grabar Datos Personales</h1>
        <span></span></div>
      <form id=login-form class="block-content form" action="../moduloPersonal" method=post>
        <div class=_100>
          <p>
          ...
          <p>
            ...
            <input id=txtdireccion name=txtdireccion type=text value=""/>
          </p>
          <p>
            <label for=txtemail>Dirección E-mail:</label>
            <input id=txtemail name=txtemail class="required email" type=text value=""/>
        </p>
          <p>
            <label for=select>Seleccione Cargo</label>
...
%>
        ...
        <div class=block-actions>
          <ul class=actions-left>
            <li><a class="button red" id=reset-validate-form href="personal.jsp">Cancelar</a></li>
          </ul>
          <ul class=actions-right>
            <li>
            ...
            <%
                    ...
                    try {
                        ...
                        String a="select p.IdPersonal,p.Nombres,p.Apellidos,p.DNI,p.Telefono,p.Direccion,p.Email,c.Nombre as Cargo,p.activo from personal p, cargo c where p.IdCargo=c.IdCargo and p.IdPersonal='"+codigo+"';";               
                        ResultSet rs = stmt.executeQuery(a);
                        while (rs.next()) {

	    		nombres=String.valueOf(rs.getString(2));
                        apellidos=String.valueOf(rs.getString(3));
                        dni=String.valueOf(rs.getString(4));
                        telefono=String.valueOf(rs.getString(5));
                        direccion=String.valueOf(rs.getString(6));
                        email=String.valueOf(rs.getString(7));
                        cargo=String.valueOf(rs.getString(8));
                        activo=String.valueOf(rs.getString(9));
    ...
    <div class=block-border>
      ...
      <form id=login-form  class="block-content form" action="../moduloPersonal" method=post>
        <div class=_100>
          ...
          <p>
            <label for=select2>Seleccione Cargo</label>
            <select name="cbocargo" id="cbocargo">
              <%
           Aux = combo.llenarCargo();
...
%>
        ...
        <div class=block-actions>
          <ul class=actions-left>
            <li><a class="button red" id=reset-validate-form2 href="personal.jsp">Cancelar</a></li>
          </ul>
          <ul class=actions-right>
            <li>
