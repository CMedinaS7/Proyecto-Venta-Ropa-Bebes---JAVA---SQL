...
<%
		    ...
		    String per=null,cli=null,pro=null,com=null;	
                    try {
                		
                        cn = con.getAccesoBD();
                        Statement stmt = cn.createStatement();
			String a="call sp_totales;";               
			ResultSet rs = stmt.executeQuery(a);
                        while (rs.next()) {
                                cli=String.valueOf(rs.getString(1));
                                pro=String.valueOf(rs.getString(2));
                                com=String.valueOf(rs.getString(3));
                                per=String.valueOf(rs.getString(4));                                  
                        }
					%>
...
</aside> <div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Principal</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12> <div class=grid_12> <h1>Menu Principal </h1>
  <div class="alert info"><span class=hide>x</span><strong>Recuerde leer los terminos y condiciones que impone la empresa para poder usar el intranet BABY MODAS de forma apropiada y correcta. Att. El Administrador</strong>.</div> </div> <div class=grid_12> <div class=block-border> <div class=block-content> <ul class=shortcut-list> <li> <a href="reportes.jsp"> <img src="img/icons/packs/crystal/48x48/apps/kedit.png"> Reportes </a> </li> <li> <a href="productos.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_131.png"> Productos </a> </li> <li> <a href="clientesN.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_18.png" border="0"> Clientes </a> </li> <li> <a href="mensajes.jsp"> <img src="img/icons/packs/crystal/48x48/apps/mailreminder.png" border="0"> Mensajes </a> </li> <li> <a href="graficos.jsp"> <img src="img/icons/packs/crystal/48x48/apps/Volume%20Manager.png"> Graficos </a> </li> <li> <a href="personal.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_19.png" border="0"> Personal </a> </li> <li> <a href="javascript:void(0);" onClick="$('#info-dialog').dialog({ modal: true });">
<img src="img/icons/packs/crystal/48x48/apps/knotes.png"> Privacidad </a> </li> <li> <a href="../logoutpersonal"> <img src="img/icons/packs/crystal/48x48/apps/terminal.png" border="0"> Logout </a> </li> <li> <a href="principal.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_63.png" border="0"> Principal </a> </li> </ul> <div class=clear></div> </div> </div> </div> <div class=grid_4> <div class=block-border> <div class=block-header> 
...
<h1>Chat Corporativo</h1>
        ...
        <!-- Cuerpo donde muestra los mensajes -->
<div id="cboxdiv" style="text-align: center; line-height: 0">
<div><iframe frameborder="0" width="335" height="190" src="http://www7.cbox.ws/box/?boxid=596631&amp;boxtag=7zq2lw&amp;sec=main" marginheight="2" marginwidth="2" scrolling="auto" allowtransparency="yes" name="cboxmain7-596631" style="border:#DBE2ED 1px solid;" id="cboxmain7-596631"></iframe>
</div>

<!--  Pie de formulario donde se ingresa el nombre y mensajes -->

<div><iframe frameborder="0" width="335" height="75" src="http://www7.cbox.ws/box/?boxid=596631&amp;boxtag=7zq2lw&amp;sec=form" marginheight="2" marginwidth="2" scrolling="no" allowtransparency="yes" name="cboxform7-596631" style="border:#DBE2ED 1px solid;border-top:0px" id="cboxform7-596631"></iframe></div>
</div>
<!-- END CBOX -->
        ...
        </div> </div> <div class=grid_4> <div class=block-border> <div class=block-header> <h1>Productos mas Vendidos</h1><span></span> </div> <div class=block-content> <ul class="block-list with-icon"> <li class=i-16-calendar>Producto 1</li> <li class=i-16-application>Producto 2</li> <li class=i-16-balloon>Producto 3</li> <li class=i-16-chart>Producto 4</li> <li class=i-16-drive>Producto 5</li> </ul> </div> <div class="block-content dark-bg"> <p>Para ver la lista completa  revise los reportes diarios.</p> </div> </div> </div> <div class=grid_4> <div class=block-border> <div class=block-header> <h1>Informacion Basica</h1><span></span> </div> <div class=block-content> <div class="alert info no-margin top">Muestra el total de los registros almacenados en la Base de Datos.</div> <ul class=overview-list> <li><a href="javascript:void(0);"><span><%=pro%></span> Total Productos</a></li> <li><a href="javascript:void(0);"><span><%=cli%></span> Total Clientes</a></li> <li><a href="javascript:void(0);"><span><%=per%></span>Total Personal</a></li> <li><a href="javascript:void(0);"><span><%=com%></span>Total de ventas</a></li> </ul> </div> </div> </div> <div class="clear height-fix"></div> </div></div> </div> <footer id=footer><div class=container_12> <div class=grid_12> <div class="footer-icon align-center"><a class=top href="#top"></a></div> </div> </div></footer> </div> <script>window.jQuery||document.write('<script src="js/libs/jquery-1.6.2.min.js"><\/script>');</script> 
