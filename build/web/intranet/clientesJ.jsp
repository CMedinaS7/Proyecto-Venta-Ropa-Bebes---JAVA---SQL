...
</aside> <div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Clientes</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12> <div class=grid_12> <h1>Clientes Jurídicos</h1></div> <div class=grid_12>
  <div class=block-border>
    <div class=block-header>
      <h1>Lista de todos los clientes (JURIDICOS)</h1>
      <span></span></div>
    <div class=block-content>
      <div class="alert note no-margin top">Nota: Los clientes que no se encuentre activos en la empresa, el codigo se mostrara de color rojo.</div>
      <%if("0".equals(resp)){%>
      ...
      <%}
			...
			String a="select c.IdCliente,cj.RazonSocial,cj.RUC,c.direccion,c.email,c.telefono,c.estado from cliente c,c_juridico cj where c.IdCliente=cj.IdCliente;";               
                        ResultSet rs = stmt.executeQuery(a);
                        out.println("<table id=table-example class=table><thead><tr><th>IdCliente</th><th>Razon Social</th><th>RUC</th><th>Direccion</th><th>E-mail</th><th>Telefono</th></tr></thead><tbody>");
                        while (rs.next()) {
                            
                            out.println("<tr class=gradeA>"); 
                            cod=String.valueOf(rs.getString(1));
			    estado=String.valueOf(rs.getString(7));
			    if("1".equals(estado)){
			    out.println("<td><a href=clientes1.jsp?cod="+cod+">"+rs.getString(1)+"</a></td>");
                            }else{
                            out.println("<td><a href=clientes1.jsp?cod="+cod+"><font color=#CC0033>"+rs.getString(1)+"</a></td>");
                            }
