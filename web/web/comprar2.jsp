        ...
        <div id="main"> 
            ...
            <div class="grid box-1">
              <div class="box-2 span-10 lineaReg">
                <div> <span class="punto">&bull;</span><br>
                  Registro </div>
                <div class="act"> <span class="puntoAct">&bull;</span><br>
                  Detalles </div>
                <div> <span class="punto">&bull;</span><br>
                  Facturación </div>
                <div class="last-child"> <span class="punto">&bull;</span><br>
                  Confirmación </div>
              </div>
              <div class="grid box-16">
       
                  <p class="parrafo19">Cliente: <%=(String) sesion.getAttribute("Cnombres")%></p>
                  <div class="lineSeparator1 box-18"></div>
<p class="parrafo19">Direccion: <%=(String) sesion.getAttribute("Cdireccion")%></p>
<div class="lineSeparator1 box-18"></div>
<p class="parrafo19">Telefono: <%=(String) sesion.getAttribute("Ctelefono")%></p>
<div class="lineSeparator1 box-18"></div>
<p class="parrafo19">mail: <%=(String) sesion.getAttribute("Cemail")%></p>
               ...
               <label class="lblsubmit1 left">
                ...
                <div>
                    <label class="lblsubmit">
                      <button onClick="location.href='comprar3.jsp'" type="submit" class="submit">Continuar</button>
                    </label>
                  </div>
