<%-- 
    Document   : nosotros
    Created on : 20-may-2012, 17:35:59
    Author     : user
--%>
      ...
      <img src="image/img.jpg">
        ...
        <div id="main"> 
            ...
            <div class="grid box-1" id="informativo"> 
			  ...
			  <h2 class="h5">Nuestra Misión</h2>
				<ul>
				  <li>Somos una empresa comprometida a satisfacer las necesidades de nuestros clientes, con una atención personalizada eficiente, con un producto integral de calidad.La innovación será constante en todas nuestras áreas y procesos, logrando el desarrollo de nuestros colaboradores, a fin de ser una empresa competitiva y rentable.</li>
			  </ul>
				<h3 class="h5">Nuestros Valores:</h3>
				<h4>Responsabilidad Y Trabajo:</h4>
			  <ul>
				  <li>El brindar un producto integral de calidad, nos obliga a trabajar con responsabilidad en la función asignada.</li>
				  <li>Creamos y actuamos dentro de una cultura de ahorro para nuestra empresa, buscando oportunidad de eficiencia y productividad.</li>
				  <li>Nos fijamos metas, plazos y retos agresivos y lo cumplimos. <br>
			      </li>
			  </ul>
				<h4 class="h5">Solidaridad Y Hermandad:</h4>
				<ul>
				  <li>El Trabajo en conjunto nos permite lograr más que individuamente. Sabemos escuchar poniéndonos en el lugar de la otra persona.</li>
				  <li>El problema de uno es el problema de todos.</li>
				  <li>Sabemos escuchar poniéndonos en el lugar de la otra persona. <br>
			      </li>
				  <li>Somos una familia, por lo tanto velamos por el bienestar de cada uno de sus miembros.<br>
			      </li>
			  </ul>
				<h4 class="h5">Honestidad:</h4>
				<ul>
				  <li>Tenemos ética profesional, laboral y moral con nuestros clientes, proveedores y nuestros colaboradores de acuerdo a las normas de la empresa y la sociedad.</li>
				  <li>Decimos siempre la verdad y asumimos nuestros errores.     <br>
			      </li>
			  </ul>
				<h4 class="h5">Superacion:  </h4>
			  <ul>
				  <li>Desterramos los quehaceres tradicionales de las cosas, y cada día buscamos innovar. <br>
		        </li>
				  <li>Somos flexibles y promovemos el cambio.</li>
				  <li>Buscamos y apoyamos el crecimiento a nivel personal y profesional de nuestros colaboradores.</li>
			  </ul>
            </div> 
