...
</aside> <div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Clientes</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12> <div class=grid_12> <h1>Clientes Naturales </h1></div> <div class=grid_12>
  <div class=block-border>
    <div class=block-header>
      <h1>Lista de todos los clientes (NATURALES)</h1>
      <span></span></div>
    <div class=block-content>
      ...
      <div class="alert error no-margin top"><span class=hide>x</span>Error: Ha ocurrido un error al relizar la operación, los datos no se han actualizado con exito, intentelo mas tarde!!!.</div>%>
        ...
        %><%
			...
			String a="select c.IdCliente,c.Direccion,c.Email,C.Telefono,concat(cn.Nombres,' ',cn.Apellidos),cn.DNI,c.Estado from cliente c,c_natural cn where cn.IdCliente=c.IdCliente";               
			ResultSet rs = stmt.executeQuery(a);
                        out.println("<table id=table-example class=table><thead><tr><th>IdCliente</th><th>Nombre Completo</th><th>DNI</th><th>Direccion</th><th>E-mail</th><th>Telefono</th></tr></thead><tbody>");
                        while (rs.next()) {
